...
namespace Tropical.Infrastructure.Helper
{
    ...
    {
        public static MvcHtmlString CustomViewDateFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression)
        {
            ...
            String htmlToRender = GetViewHtml(htmlHelper.ViewContext, "~/Views/Shared/CustomViewDate.cshtml");
